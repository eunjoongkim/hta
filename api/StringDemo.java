public class StringDemo {
	...
	public static void main(String[] args) {
		...
		/*
			String 클라스
				String 클라스는 문자열을 표현한다.
				String값은 불변값이다. 한번 만들어진 이후에는 변경할 수 없다.
				String은 객체를 생성하는 특별한 방법을 제공한다.
					String str = new String("abc");		// 생성자를 이용한 String 생성
					String stc = "abc"					// 문자열 표현식을 이용한 String 객체 생성
		...
		*/
		...
		// 문자열의 내용을 비교해서 동일한 내용을 가진 문자열일지 여부를 반환하는 메소드 : boolean equals(Object str)
		String str4 = "애플";
		String str5 = "애플";
		...
		System.out.println("대소문자 구분없이 비교했을 때 동일한 문자열인가? " + equals2);

		// 문자열이 지정한 문자열을 포함하고 있는지 여부를 반환하는 메소드 : boolean contains(String s)
		String str8 = "자바 프로그래밍 - 자바 기초 및 응용";
		boolean a = str8.contains("자바");
		System.out.println("[자바]라는 문자열을 포함하고 있는가?" + a);
		...
		// 문자열의 내욜을 지정된 문자열로 대체한 새로운 문자열을 반환하는 메소드 : String replace(String tartget, String newStr)
		String str9 = str8.replace("자바", "파이썬");
		System.out.println("str8 ["+str8+"]");
		System.out.println("str9 ["+str9+"]");

		// 문자열에서 지정된 위치부터 끝까지 문자열을 잘라서 반환하는 메소드 : String substrring(int beginIndex)
