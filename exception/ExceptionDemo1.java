...
public class ExceptionDemo1 {
	...
	public static void main(String[] args) {
		try {
			...
			BufferedReader reader = new BufferedReader(new FileReader("Mㅎㅎemo.txt"));
			
			// IOExceoption을 던지는 메소드
			...
			//예외 처리 코드 각성
			// 사용자 친화적인 에러 메시지를 표시한다.
			System.out.println("파일을 찾을 수 없습니다. 경로 및 파일명을 확인하세요");
		
		} catch (IOException ioe) {
			System.out.println("파일을 읽어오는 도중 오류가 발생했습니다. 접송상태를 확인하세요.");
		}
	}
